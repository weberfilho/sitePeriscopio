...
import { EventSuggestion } from "@/interfaces/event";
  ...
  return (
    <div className="mb-8 px-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <legend className="mt-4">Nome do Evento:</legend>
        <input
          type="text"
        ...
        <legend className="mt-2">Cidade do Evento:</legend>
        <input
          type="text"
          className="flex min-h-12 w-full flex-row rounded-md border-2 border-solid border-black px-4 shadow-md shadow-gray-500"
        ...
        <legend className="mt-2">Descrição (data, local, atrações etc):</legend>
        <input
          type="text"
